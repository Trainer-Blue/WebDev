...
app.get("/filter",(req,res)=>{
  ...
  let filteredJokes = jokes.filter((joke) => joke.jokeType == jokeType);
...
app.patch("/jokes/:id",(req,res)=>{
  ...
  let updatedJoke = {
    id: jokeId,
    jokeText: req.body.text || jokes[jokeId - 1].jokeText,
    jokeType: req.body.type || jokes[jokeId - 1].jokeType,
  };
  jokes[jokeId - 1] = updatedJoke;
  res.json(updatedJoke);
}
...
app.delete("/jokes/:id",(req,res)=>{
  ...
  if(jokes.findIndex((joke) => joke.id == jokeId) == id){
